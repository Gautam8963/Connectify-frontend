...
const UserCard = ({ user }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4">
      ...
      >
        {/* Main Card */}
        <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-white" style={{ height: '75vh', maxHeight: '650px', minHeight: '500px' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              <div className="flex items-end justify-between mb-3">
                ...
                {matchScore !== undefined && matchScore > 0 && (
                  <div className="bg-[#FF4458] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex-shrink-0">
                    {matchScore}% Match
                  </div>
                )}
              </div>
        ...
        {/* Action Buttons */}
        <div className="flex justify-center items-center gap-6 mt-5 mb-4">
          {/* Pass Button */}
          <motion.button
          ...
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="w-20 h-20 rounded-full tinder-gradient flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300"
